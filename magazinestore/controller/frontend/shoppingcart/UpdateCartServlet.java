...
public class UpdateCartServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String[] arrayRivistaIds = request.getParameterValues("rivistaId");
		String[] arrayQuantities = new String[arrayRivistaIds.length];
		...
		int[] rivistaIds = Arrays.stream(arrayRivistaIds).mapToInt(Integer::parseInt).toArray();
