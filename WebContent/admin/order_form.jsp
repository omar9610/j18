...
<body>
	...
	<div align="center">
		<h2 class="pageheading">Edit Order ID: ${order.ordineId}</h2>		
	</div>
		...
		<table border="1">
			...
			<tr>
				...
				<td>
					...
					<fmt:formatNumber value="${orderDetail.rivista.price}" type="currency" />
				</td>
				<td>
				...
				<td><a href="remove_book_from_order?id=${orderDetail.rivista.rivsitaId}">Remove</a></td>
			</tr>
			</c:forEach>
			<tr>
	...
	<div align="center">
		<br/>		
		<a href="javascript:showAddBookPopup()"><b>Add Magazine</b></a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
